...
rm $OS/airootfs/root/install.sh $OS/airootfs/root/install-dev.sh $OS/airootfs/root/install-server.sh
...
cp -f ../gopios/src/root/setup-gopios-dev.sh $OS/airootfs/root/setup-gopios.sh
